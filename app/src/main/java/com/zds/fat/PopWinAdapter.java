...
public class PopWinAdapter extends ArrayAdapter<String> {
    ...
    public PopWinAdapter(List<String> listData_, Context context, int resource) {
        ...
        textView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(btn.getText() == "删除") {
                    ...
                    PopWinAdapter.selectCmd = CMD_DEL;
                }else {
                    System.out.println("CMD_MODIFY");
                    PopWinAdapter.selectCmd = CMD_MODIFY;
                }
                int a = btn.getId();
                PopWin.popWin.dismiss();
            }
        });
        return view;
    }
